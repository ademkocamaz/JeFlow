    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True, verbose_name='Oluşturulma Tarihi')),
                ('process', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.process', verbose_name='İş Akış Tanımı')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True, verbose_name='Oluşturulma Tarihi')),
                ('process_detail', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.processdetail', verbose_name='İş Adı')),
            ],
            options={
                'verbose_name': 'Görev',
